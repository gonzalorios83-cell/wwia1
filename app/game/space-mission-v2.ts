...
export const SPACE_MISSION_V2: Record<SpaceMissionV2Id, SpaceMissionV2Config> = {
  moon: {
    ...common, label: "LUNA", map: "CUENCA LUNAR", description: "Sector lunar de baja gravedad, con horizonte negro y terreno gris mate.", terrain: "/assets/space-v2/maps/luna.webp", navigation: "/assets/space-v2/nav/luna_nav.png",
  ...
  mars: {
    ...common, label: "MARTE", map: "OLYMPUS MONS", description: "Sector marciano con Olympus Mons visible al horizonte.", terrain: "/assets/space-v2/maps/marte.webp", navigation: "/assets/space-v2/nav/marte_nav.png",
  ...
  mercury: {
    ...common, label: "MERCURIO", map: "SOL QUEMADO", description: "Superficie gris-beige, quemada por el Sol, con cielo negro y estrellas.", terrain: "/assets/space-v2/maps/mercurio.webp", navigation: "/assets/space-v2/nav/mercurio_nav.png",
